...
def main(sysargs = sys.argv[1:]):
    ...
    parser.add_argument('-d', '--data', action='store',help="Optional data directory to overwrite the default package data. Minimally containing a fasta alignment and guide tree")
